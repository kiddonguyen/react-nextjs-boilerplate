...
/**
 * Renders a property agent component.
 *
 * @param {PropertyAgent} agent - The agent's information.
 * @return {JSX.Element} The rendered property agent component.
 */
function Agent({ name, address, properties }: PropertyAgent): JSX.Element {
  return (
...
function Gallery({ data }: { data: PropertyItemData }): JSX.Element {
  return (
